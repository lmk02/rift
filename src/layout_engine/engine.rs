...
impl LayoutEngine {
    ...
    pub fn move_workspace_to_space(
        ...
        let windows = self.virtual_workspace_manager.relocate_workspace(
            window_store,
            workspace_id,
            new_space,
        );
    ...
    pub fn move_window_to_space(
        ...
        let lands_visible = self.virtual_workspace_manager.active_workspace(target_space)
        ...
        EventResponse {
            changed: true,
            raise_windows: if lands_visible {
                vec![window_id]
            } else {
                Vec::new()
            },
